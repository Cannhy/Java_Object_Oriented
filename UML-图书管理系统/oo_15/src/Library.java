...
public class Library {
    ...
    private HashMap<String, Integer> bookCounter = new HashMap<>();
    ...
    public void dealBorrowedB(String[] req, String req2) {
        int tempCnt;
        ...
        if (tempCnt != 0) {
            ...
            if (!students.get(req[1]).HaveB()) {
                ...
                students.get(req[1]).getBorrowDate().put(req[3],
                        Date2Day(req[0].substring(1, 11)));
                clearB2(req[1]);
    ...
    public void dealReturnB(String[] req) {
        ...
        boolean outDate = (Date2Day(req[0].substring(1, 11)) - student.getBorrowDate()
                .get(req[3])) > 30;
        if (student.getIsSmeared().get(req[3]) || outDate) {
            System.out.println(req[0] + " " + req[1]
                    + " got punished by borrowing and returning librarian");
            System.out.println(req[0] + " " + "borrowing and returning librarian received "
                    + req[1] + "'s fine");
        ...
        student.getBookBs().remove(req[3]);
        student.getBorrowDate().remove(req[3]);
        student.SetB(false);
    }
        ...
        for (int i = 0; i < orders.size(); i++) {
            ...
            if (order.getDate() < date) {
                ...
                if (pos != -1) {
                    ...
                    students.get(order.getStudent()).getBorrowDate().
                            put(order.getBookNumber(), date);
